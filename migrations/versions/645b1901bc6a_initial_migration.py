...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "score", sa.DOUBLE_PRECISION(precision=53), server_default=sa.text("0"), autoincrement=False, nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["employeeID"],
            ["Employee.id"],
            name=op.f("PaySlip_employeeID_fkey"),
            onupdate="CASCADE",
            ondelete="RESTRICT",
        ),
    ...
    op.create_table(
        ...
        sa.Column("updatedAt", postgresql.TIMESTAMP(precision=3), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["fromID"], ["Employee.id"], name=op.f("Message_fromID_fkey"), onupdate="CASCADE", ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["toID"], ["Employee.id"], name=op.f("Message_toID_fkey"), onupdate="CASCADE", ondelete="RESTRICT"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["teamID"], ["Teams.id"], name=op.f("TeamTask_teamID_fkey"), onupdate="CASCADE", ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column("updatedAt", postgresql.TIMESTAMP(precision=3), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["fromID"], ["Employee.id"], name=op.f("TeamMessage_fromID_fkey"), onupdate="CASCADE", ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["toID"], ["Teams.id"], name=op.f("TeamMessage_toID_fkey"), onupdate="CASCADE", ondelete="RESTRICT"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            postgresql.ENUM(
                "Documents", "Vacation", "Leave", "Training", "Raise", "Department", "Other", "Sick", name="RequestType"
            ),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["employeeID"],
            ["Employee.id"],
            name=op.f("Request_employeeID_fkey"),
            onupdate="CASCADE",
            ondelete="RESTRICT",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM("Admin", "Employee", "Manager", name="CompanyRole"),
            server_default=sa.text("'Employee'::\"CompanyRole\""),
            autoincrement=False,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["teamsId"], ["Teams.id"], name="Employee_teamsId_fkey", onupdate="CASCADE", ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["employeeID"],
            ["Employee.id"],
            name=op.f("Schedule_employeeID_fkey"),
            onupdate="CASCADE",
            ondelete="RESTRICT",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["employeeID"],
            ["Employee.id"],
            name=op.f("PaySlipData_employeeID_fkey"),
            onupdate="CASCADE",
            ondelete="RESTRICT",
        ),
